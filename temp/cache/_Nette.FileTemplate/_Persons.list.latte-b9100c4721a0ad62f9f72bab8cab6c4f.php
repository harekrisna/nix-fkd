<?php //netteCache[01]000384a:2:{s:4:"time";s:21:"0.70338400 1452509903";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:62:"/Users/bart/PHP/NIX farma/web/app/templates/Persons/list.latte";i:2;i:1452509873;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f8aa369 released on 2012-08-30";}}}?><?php

// source file: /Users/bart/PHP/NIX farma/web/app/templates/Persons/list.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'fv835f5edp')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb59eda1a70c_head')) { function _lb59eda1a70c_head($_l, $_args) { extract($_args)
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2fef9adec6_content')) { function _lb2fef9adec6_content($_l, $_args) { extract($_args)
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate("paginator.latte", $template->getParameters(), $_l->templates['fv835f5edp'])->render()  ?>
...
// block _personsList
//
if (!function_exists($_l->blocks['_personsList'][] = '_lb0ba47cb7fd__personsList')) { function _lb0ba47cb7fd__personsList($_l, $_args) { extract($_args); $_control->validateControl('personsList')
...
// block _personInfo
//
if (!function_exists($_l->blocks['_personInfo'][] = '_lba2f65d3f1e__personInfo')) { function _lba2f65d3f1e__personInfo($_l, $_args) { extract($_args); $_control->validateControl('personInfo')
;if (isset($person_id)): ?>
        <ul id="tabs">
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lbecb314f681_scripts')) { function _lbecb314f681_scripts($_l, $_args) { extract($_args)
