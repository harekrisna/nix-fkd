<?php //netteCache[01]000389a:2:{s:4:"time";s:21:"0.36865500 1422961675";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:67:"/data/www/virtuals/jamuna/html/nix/app/templates/Persons/list.latte";i:2;i:1422961674;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f8aa369 released on 2012-08-30";}}}?><?php

// source file: /data/www/virtuals/jamuna/html/nix/app/templates/Persons/list.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '5so5tylfo0')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb9136754dd0_head')) { function _lb9136754dd0_head($_l, $_args) { extract($_args)
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf5fa21bf55_content')) { function _lbf5fa21bf55_content($_l, $_args) { extract($_args)
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate("paginator.latte", $template->getParameters(), $_l->templates['5so5tylfo0'])->render()  ?>
...
// block _personsList
//
if (!function_exists($_l->blocks['_personsList'][] = '_lb53fb664b97__personsList')) { function _lb53fb664b97__personsList($_l, $_args) { extract($_args); $_control->validateControl('personsList')
...
// block _personInfo
//
if (!function_exists($_l->blocks['_personInfo'][] = '_lb9db491eb51__personInfo')) { function _lb9db491eb51__personInfo($_l, $_args) { extract($_args); $_control->validateControl('personInfo')
;if (isset($person_id)): ?>
        <ul id="tabs">
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lb5b51233cc1_scripts')) { function _lb5b51233cc1_scripts($_l, $_args) { extract($_args)
